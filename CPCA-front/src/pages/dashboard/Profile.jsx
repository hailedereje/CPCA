...
export default function Profile() {
  ...
  console.log("users:", user); // Debug log
  const [editUserInfo, { isLoading: isSaving, error }] =
            ...
            <div className="p-7">
              <form>
                ...
                <button
                  onClick={openUploadWidget}
                  type="button"
                  className="relative mb-5 block  w-full cursor-pointer appearance-none rounded border border-dashed border-primary bg-gray py-4 px-4 hover:bg-base-200 sm:py-7.5"
                >
                  <input
                ...
                <div className="flex justify-end gap-4">
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setFormData({ ...formData, profileImg: user.profileImg })
                    }
                  >
                    Cancel
                  </button>
